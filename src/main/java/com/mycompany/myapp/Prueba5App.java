...
public class Prueba5App {

    private static final Logger log = LoggerFactory.getLogger(Prueba5App.class);

    private final Environment env;

    public Prueba5App(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Prueba5App.class);
